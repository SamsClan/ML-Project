...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Categorical columns: {categorical_cols}")
            logging.info("Numerical columns: {numerical_cols}")
            ...
            logging.info("Pipeline for numerical and categorical dataframe is created.")
            return preprocessor
